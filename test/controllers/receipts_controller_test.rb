...
class ReceiptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create receipt" do
    assert_difference('Receipt.count') do
      post receipts_url, params: { receipt: { content: @receipt.content, title: @receipt.title } }
    end
  ...
  test "should update receipt" do
    patch receipt_url(@receipt), params: { receipt: { content: @receipt.content, title: @receipt.title } }
